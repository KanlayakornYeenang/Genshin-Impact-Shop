                ...
                <div className="frame-circle">
                    ...
                    {(() => {
                        switch (popup) {
                            ...
                            case "Email":
                                return <Email handleClick={handleClick} setEmail={setEmail} email={email} />;
                            case "Username":
                                return <Username handleClick={handleClick} setUsername={setUsername} username={username} />;
                            case "Password":
                                return <Password handleClick={handleClick} setPassword={setPassword} password={password} />;
                            case "Done":
                                return <SignIn handleClick={handleClick} />;
                            default:
                                return null;
...
const Email = ({ handleClick, setEmail, email }) => {
...
const Username = ({ handleClick, setUsername, username }) => {
    return (
        <div className="frame-circle-in">
...
const Password = ({ handleClick, setPassword, password }) => {
    return (
        <div className="frame-circle-in">
