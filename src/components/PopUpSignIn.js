...
const GoToEmail = () => {
  ...
  document.getElementsByClassName("singin-input-container")[0].style.display =
    "none";
  ...
  document.getElementsByClassName("frame-circle-in")[0].style.animation =
    "popup 0.75s";
};
...
const GoToUsername = () => {
  ...
  document.getElementsByClassName("already-ac")[0].style.display = "none";
  document.getElementsByClassName("create-email")[0].style.display = "none";
  document.getElementsByClassName("create-username-h1")[0].style.display =
    "block";
  document.getElementsByClassName("username-detail")[0].style.display = "block";
  document.getElementsByClassName("textfield-username")[0].style.display =
    "block";
...
const GoToPassword = () => {
  ...
  document.getElementsByClassName("create-password-h1")[0].style.display =
    "block";
  document.getElementsByClassName("password-detail")[0].style.display = "block";
  document.getElementsByClassName("textfield-password")[0].style.display =
    "flex";
...
const CssTextField = styled(TextField)({
  "& .MuiOutlinedInput-root": {
    ...
    "&.Mui-focused fieldset": {
      border: "0.2vw solid rgba(17, 17, 17)",
    },
  },
});
      ...
      >
        <div className="frame-circle">
          ...
          <div className="frame-circle-in">
            ...
            <div className="createac" onClick={GoToEmail}>
              CREATE ACCOUNT
            </div>
            <div className="already-ac" onClick={GoBackSignIn}>
